...
export namespace Prisma {
  ...
  */
  ...
  export type TodosOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "task" | "completed" | "userId", ExtArgs["result"]["todos"]>
  ...
  interface TodosFieldRefs {
    ...
    readonly task: FieldRef<"Todos", 'String'>
  ...
  export type TodosWhereInput = {
    ...
    task?: StringFilter<"Todos"> | string
  ...
  export type TodosScalarWhereWithAggregatesInput = {
    ...
    task?: StringWithAggregatesFilter<"Todos"> | string
